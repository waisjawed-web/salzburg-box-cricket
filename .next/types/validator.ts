...
// Validate ../../app/api/stripe-checkout-placeholder/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/stripe-checkout-placeholder">> = Specific
  const handler = {} as typeof import("../../app/api/stripe-checkout-placeholder/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
